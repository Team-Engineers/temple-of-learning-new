    ...
    <div className="container mx-auto py-8">
      <form className="max-w-lg mx-auto bg-white  rounded  pt-6 pb-8 mb-4">
        ...
        <div className="mb-6">
          ...
          <input className="  border-b border-gray-500 w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="password" placeholder="Password" />
        </div>
        <div className="mb-6">
          <button className="bg-[#77D3FF] w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline shadow-md rounded-lg"> Create Account </button>
        </div>
        <div className="mb-4">
