            ...
            <div className='grid grid-cols-3'>
                ...
                <div className='form-container max-w-[600px]'>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            <input type="text" id="school" value={school} onChange={(e) => setSchool(e.target.value)} placeholder='School' className="placeholder-style1" />
                        </div>
                        <div className="form-group">
                            <input type="text" id="state" value={state} onChange={(e) => setState(e.target.value)} placeholder='State' className="placeholder-style1" />
                        </div>
                        <div className="form-group">
